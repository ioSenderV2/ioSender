...
namespace CNC.Core
{
    // JogMode and JogCommand moved to CNC Contracts (JogMessages.cs), same namespace - JogCommand is
    // the command channel's wire shape for a jog request (step 6 of the client/server split).
