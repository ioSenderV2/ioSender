...
TARGETS = [
    ...
    ('CNC Controls/CNC Controls/SurfaceStockWizard.xaml', 'CNC.Controls.WPF'),
    ('CNC Controls/CNC Controls/DrillBoreWizard.xaml', 'CNC.Controls.WPF'),
    ('CNC Controls/CNC Controls/CounterboreWizard.xaml', 'CNC.Controls.WPF'),
    ('CNC Controls/CNC Controls/PocketWizard.xaml', 'CNC.Controls.WPF'),
    ('CNC Controls/CNC Controls/ContourWizard.xaml', 'CNC.Controls.WPF'),
