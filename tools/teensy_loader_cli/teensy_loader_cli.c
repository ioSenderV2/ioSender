...
// PATCHED (ioSender vendoring, see build.ps1): upstream includes <ddk/hidsdi.h> and <ddk/hidclass.h>
// for the old mingw32msvc cross-compiler; MinGW-w64 ships the same headers without the ddk/ prefix.
#include <windows.h>
#include <setupapi.h>
#include <hidsdi.h>
#include <hidclass.h>
